...
<body>
   ...
   <div class="container mb-4">
      ...
      <div class="col-lg-12 px-0">
         ...
         <div class="jumbotron text-center bg-white px-0 py-4">
            <h2 class="display-6 mb-0">HOMEAL'S STORY</h2>
            <div class="row">
               <div class="col-5"></div>
               <div class="col-2">
                  <hr class="my-4">
            ...
            <p class="lead mb-0">이젠 집에서 간편하게 요리하세요!</p>
         </div>
         
         <div class="row">
         	<div class="col-2"></div>
         	<div class="col-8"><img class="img-fluid" src="http://placehold.it/1200x800" alt=""></div>
         	<div class="col-2"></div>
         </div>
