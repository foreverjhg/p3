...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
      ...
      <div class="row">
         <div class="col-12">
            <img src="<c:url value='/resources/img/apasta/aglio3.PNG' />" alt="" class="img-fluid" >
         </div>
      </div>
      
      
      <div class="jumbotron text-center bg-white px-0 my-3">
            <h2 class="display-6">마늘과 올리브오일의 만남! HOMEAL의 알리오올리오 파스타</h2>
            <div class="row">
               <div class="col-5"></div>
               <div class="col-2">
                  <hr class="my-5">
            ...
            <p class="lead mb-2">깔끔하고 담백한 알리오올리오</p>
            <p class="lead">감칠맛 가득한 풍미! 집에서 쉽고 간편하게 HOMEAL하세요</p>
         </div>
         
         <div class="row">
         <div class="col-12 ">
            <img src="<c:url value='/resources/img/apasta/aglio4.PNG' />" alt="" class="img-fluid">
         </div>
      ...
      <div class="jumbotron text-left bg-white px-0 pb-2 mb-0">
        ...
        <div class = "row">
           <div class="col-8">
              <img src="<c:url value='/resources/img/img/cpasta/Cpast1.PNG' />" alt="" class="img-fluid">
           </div>
           <div class="col-4">
              ...
              스파게티면<br><br>올리브오일<br><br>마늘<br><br>멸균우유<br><br>베이컨<br><br>크림파스타소스<br><br>
              </p>
           </div>
      </div>
        ...
        <div class="jumbotron text-left bg-white px-0 pb-2 mb-0">
            <h3 class="display-6">HOMEAL과 함께하는 크림파스타 레시피</h3>
            <div class="row">
               <div class="col-12">
                  <hr class="my-3">
               </div>
        ...
        <div class="row">
           <div class = "col-6">
              ...
              <div class = "col-12 py-3 px-0 d-flex">
                 ...
                 <div class="col-11">
                    <h5>재료 손질하기</h5>
                    <p>면을 8~10분간 삶은 후 면수는 따로 남겨주시고, 마늘과 양파를 깨끗이 손질 후 마늘은 편썰기, 양파는 잘게, 베이컨은 1cm 정도 먹기 좋은 크기로 잘라주세요.</p>
                 </div>
              </div>
           </div>
        ...
        <div class="row">
           ...
           <div class = "col-6">
              <img src=<c:url value='/resources/img/dcpasta/Cpasta5.jpg' /> alt="" class="img-fluid">
              <div class = "col-12 py-3 px-0 d-flex">
                 <div class="col-1"><a href="#"><img class="rounded-circle"
                     src="http://placehold.it/30x30" alt=""></a></div>
                 <div class="col-11">
                    <h5>Tip. 꿀팁정보!</h5>
                    <p>빵과 함께 드시면 더욱 맛있게 즐길 수 있습니다.</p>
                 </div>
              </div>
           </div>
        </div>
