...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
      ...
      <div class="jumbotron text-left bg-white px-0 pb-2 mb-0">
        ...
        <div class = "row">
           <div class="col-8">
              <img src="<c:url value='/resources/img/apasta/aglio10.PNG' />" alt="" class="img-fluid">
           </div>
           <div class="col-4">
              ...
              스파게티면<br><br>올리브오일<br><br>마늘<br><br>베트남고추<br><br>허브시즈닝<br><br>
              </p>
           </div>
      </div>
        ...
        <div class="jumbotron text-left bg-white px-0 pb-2 mb-0">
            <h3 class="display-6">HOMEAL과 함께하는 알리오올리오파스타 레시피</h3>
            <div class="row">
               <div class="col-12">
                  <hr class="my-3">
               </div>
