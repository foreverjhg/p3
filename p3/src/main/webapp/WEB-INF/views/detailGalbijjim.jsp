...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
      ...
      <div class="row">
         <div class="col-12">
            <img src="<c:url value='/resources/img/galbijjim/g_image1.PNG' />" alt="" class="img-fluid" >
         </div>
      </div>
      
      
      <div class="jumbotron text-center bg-white px-0 my-3">
            <h2 class="display-6">정성스럽게 준비한 HOMEAL의 소갈비찜</h2>
            <div class="row">
               <div class="col-5"></div>
               <div class="col-2">
                  <hr class="my-5">
            ...
            <p class="lead mb-2">국내산 소갈비와 정성스레 끓여낸 양념소스</p>
            <p class="lead">달짝지근 양념을 머금은 소갈비! 집에서 쉽고 간편하게 HOMEAL하세요</p>
         </div>
      ...
      <div class="jumbotron text-left bg-white px-0 pb-2 mb-0">
        ...
        <div class = "row">
           <div class="col-8">
              <img src="<c:url value='/resources/img/galbijjim/g_mealkit.PNG' />" alt="" class="img-fluid">
           </div>
           <div class="col-4">
              ...
              소갈비<br><br>쥬키니 호박<br><br>양파<br><br>당근<br><br>감자<br><br>은행<br><br>양념소스
              </p>
           </div>
      </div>
        ...
        <div class="jumbotron text-left bg-white px-0 pb-2 mb-0">
            <h3 class="display-6">HOMEAL과 함께하는 소갈비찜 레시피</h3>
            <div class="row">
               <div class="col-12">
                  <hr class="my-3">
               </div>
